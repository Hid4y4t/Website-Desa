            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                            <form method="POST" action="proses_edit_kemiskinan.php">

                                <div class="row mb-3">
                                    <input type="hidden" name="id_miskin" value="<?php echo $d['id_miskin']; ?>">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="status_pernikahan" aria-label="Default select example">
                                        <option selected value="Belum <?php echo $d['status_pernikahan']; ?>" > <?php echo $d['status_pernikahan']; ?> </option>
