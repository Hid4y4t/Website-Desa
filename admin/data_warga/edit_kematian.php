            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        $data = mysqli_query($koneksi, "select * from data_kematian where id_kematian='$id_kematian'");
                        while ($d = mysqli_fetch_array($data)) {
                        ?>
                            <form method="POST" action="proses_edit_kematian.php">

                                <div class="row mb-3">
                                    <input type="hidden" name="id_kematian" value="<?php echo $d['id_kematian']; ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="bulan" value="<?php echo $d['bulan']; ?>">
                                    </div>
                                </div>
