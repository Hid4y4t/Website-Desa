            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses_tambah_kematian.php">
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">BULAN KEMATIAN</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">TAHUN KEMATIAN</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <button class="btn btn-danger"> <a href="data_warga.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                                </div>
                            </div>
