                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                            ...
                            <form method="POST" action="proses_tambah_pindah.php">

                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">NIK</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="nik" readonly value="<?php echo $d['id_warga']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama" readonly value="<?php echo $d['nama_lengkap']; ?>">
                                    </div>
                                </div>
                                <!-- ====== -->
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tempat_lahir" readonly value="<?php echo $d['tempat_lahir']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tanggal_lahir" readonly value="<?php echo $d['tanggal_lahir']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">JENIS KELAMIN</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="jenis_kelamin" readonly value="<?php echo $d['jenis_kelamin']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">AGAMA</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="agama"readonly value="<?php echo $d['agama']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">PENDIDIKAN</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="pendidikan" readonly value="<?php echo $d['pendidikan']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">ALAMAT BARU</label>
                                    <div class="col-sm-10">
