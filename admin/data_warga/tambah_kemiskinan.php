            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses_tambah_kemiskinan.php">
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                   <button type="submit" class="btn btn-primary"> <i class="bi-check"></i> Kirim</button>
                                    <button class="btn btn-danger"> <a href="warga_tidak_mampu.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                                </div>
                            </div>
