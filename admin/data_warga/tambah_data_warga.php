        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                        <form method="POST" action="proses_tambah_warga.php">
                        <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-2 col-form-label">NIK</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="id_warga">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_lengkap" value="<?php echo $d['nama_bayi']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="tempat_lahir" value="<?php echo $d['tempat_dilahirkan']; ?>">
                                </div>
                            </div>
