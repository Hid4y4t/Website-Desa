                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                        <h3> DATA WARGA<br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                        <a href="tambah_warga.php"><button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Data Warga</i></button></a>
                                    </div>
                                </h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_id">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from data_warga_desa");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="view_data_warga.php?id_warga=<?php echo $d['id_warga']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                       <a href="tambah_kelahiran.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Data Kelahiran</i></button></a>
                                    </div>
                                </h5>
                                <!-- Table with hoverable rows -->
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_3">
                                        ...
                                        <tbody>
                                            ...
                                            include '../../koneksi/koneksi.php';
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from kelahiran");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_kelahiran.php?id_kelahiran=<?php echo $d['id_kelahiran']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="edit_kelahiran.php?id_kelahiran=<?php echo $d['id_kelahiran']; ?>"><button type="button" class="btn btn-outline-warning">Edit</button></a>
                                                        <a href="#" onClick="confirm_modal('hapus_kelahiran.php?id_kelahiran=<?php echo $d['id_kelahiran']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_3">
                                        ...
                                        <tbody>
                                            ...
                                            include '../../koneksi/koneksi.php';
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from data_kematian");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_kematian.php?id_kematian=<?php echo $d['id_kematian']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="edit_kematian.php?id_kematian=<?php echo $d['id_kematian']; ?>"><button type="button" class="btn btn-outline-warning">Edit</button></a>
                                                        <a href="#" onClick="confirm_modal('hapus_kematian.php?id_kematian=<?php echo $d['id_kematian']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_2">
                                        ...
                                        <tbody>
                                            ...
                                            include '../../koneksi/koneksi.php';
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from data_pindah");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_pindah.php?id_pindah=<?php echo $d['id_pindah']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="edit_pindah.php?id_pindah=<?php echo $d['id_pindah']; ?>"><button type="button" class="btn btn-outline-warning">Edit</button></a>
                                                        <a href="#" onClick="confirm_modal('hapus_pindah.php?id_pindah=<?php echo $d['id_pindah']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
