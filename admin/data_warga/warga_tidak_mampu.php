                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                        <h3> DATA WARGA TIDAK MAMPU<br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                     <a href="tambah_kemiskinan.php">   <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Data Kemiskinan</i></button></a>
                                    </div>
                                </h5>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover" id="table_id">
                                        ...
                                        <?php
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from data_kemiskinan");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="view_kemiskinan.php?id_miskin=<?php echo $d['id_miskin']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="edit_data_miskin.php?id_miskin=<?php echo $d['id_miskin']; ?>"><button type="button" class="btn btn-outline-warning">Edit</button></a>
                                                        <a href="#" onClick="confirm_modal('hapus_data_kemiskinan.php?id_miskin=<?php echo $d['id_miskin']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
