            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses_tambah_kelahiran.php">
                        <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-2 col-form-label">NAMA KEPALA KELUARGA</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="tempat_dilahirkan">
                                </div>
                            </div>
