...
<body>
    ...
    <div class="container">
        ...
        <div class="pagetitle mt-5">
            <h1>Tambah Warga Desa</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Tambah Warga Desa</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                            <form method="POST" action="proses_edit_pindah.php">

                                <div class="row mb-3">
                                    <input type="hidden" name="id_pindah" value="<?php echo $d['id_pindah']; ?>">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">NIK</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="nik" readonly value="<?php echo $d['nik']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="alamat_asal" value="<?php echo $d['alamat_asal']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="alamat_baru" value="<?php echo $d['alamat_baru']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tanggal_pindah" value="<?php echo $d['tanggal_pindah']; ?>">
                                    </div>
                                </div>
