        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="fasilitas_desa.php">
                            <i class="bi bi-circle"></i><span>Fasilitas Desa</span>
                        </a>
                    </li>
                    <li>
                        <a href="rencana_pembangunan.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                      <h3>  Data Fasilitas<br> DESA Ngadiroyo</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <center>
                                    ...
                                    <div class="icon">
                                       <a href="proses_umum/tambah_fasilitas_umum.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Fasilitas Umum</i></button></a>
                                    </div>
                                </h5>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" onClick="confirm_modal('proses_umum/hapus_data_fasilitas.php?id_fasilitas=<?php echo $d['id_fasilitas']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <center>
                                        <h3 ><b>Fasilitas Pendidikan SD/MI</b></h3>
                                    </center>
                                    <div class="icon">
                                      <a href="proses_umum/tambah_sd.php">  <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah</i></button></a>
                                    </div>
                                </h5>
                                <!-- Table with hoverable rows -->
                                <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" onClick="confirm_modal('proses_umum/hapus_sd.php?npsn=<?php echo $d['npsn']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <center>
                                        <h3 ><b>Fasilitas Pendidikan SMP</b></h3>
                                    </center>
                                    <div class="icon">
                                        <a href="proses_umum/tambah_smp.php"><button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah SMP</i></button></a>
                                    </div>
                                </h5>
                                <!-- Table with hoverable rows -->
                                <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="#" onClick="confirm_modal('proses_umum/hapus_smp.php?npsn=<?php echo $d['npsn']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <center>
                                        <h3 ><b>Fasilitas Pendidikan SMA</b></h3>
                                    </center>
                                    <div class="icon">
                                     <a href="proses_umum/tambah_sma.php">   <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah SMA</i></button></a>
                                    </div>
                                </h5>
                                <!-- Table with hoverable rows -->
                                <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="#" onClick="confirm_modal('proses_umum/hapus_sma.php?npsn=<?php echo $d['npsn']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <center>
                                        <h3 ><b>Fasilitas Pendidikan NONFORMAL</b></h3>
                                    </center>
                                    <div class="icon">
                                      <a href="proses_umum/tambah_nonformal.php">  <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Fasilitas Pendidikan Nonformal</i></button></a>
                                    </div>
                                </h5>
                                <!-- Table with hoverable rows -->
                                <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="#" onClick="confirm_modal('proses_umum/hapus_nonformal.php?npsn=<?php echo $d['npsn']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <center>
                                        <h3 ><b>Fasilitas Pendidikan KHUSUS</b></h3>
                                    </center>
                                    <div class="icon">
                                       <a href="proses_umum/tambah_khusus.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Fasilitas Pendidikan Khusus</i></button></a>
                                    </div>
                                </h5>
                                <!-- Table with hoverable rows -->
                                <div class="table-responsive">

                                <table class="table table-hover" id="table_6">
                                        <thead>
                                            <tr>
                                            <th scope="col">#</th>
                                                <th scope="col">NPSN</th>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="#" onClick="confirm_modal('proses_umum/hapus_khusus.php?npsn=<?php echo $d['npsn']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <center>
                                        <h3 ><b>Fasilitas Pendidikan UNIVERSITAS</b></h3>
                                    </center>
                                    <div class="icon">
                                       <a href="proses_umum/tambah_universitas.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Universitas</i></button></a>
                                    </div>
                                </h5>
                                <!-- Table with hoverable rows -->
                                <div class="table-responsive">

                                <table class="table table-hover" id="table_7">
                                        <thead>
                                            <tr>
                                            <th scope="col">#</th>
                                                <th scope="col">NPSN</th>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="#" onClick="confirm_modal('proses_umum/hapus_universitas.php?npsn=<?php echo $d['npsn']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
