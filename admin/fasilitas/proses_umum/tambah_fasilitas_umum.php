            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses_tambah_fasilitas.php">
                        <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-2 col-form-label">Nama Fasilitas</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Lokasi Fasilitas</label>
                                <div class="col-sm-10">
