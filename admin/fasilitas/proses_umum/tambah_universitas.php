...
<body>
    ...
    <div class="container">
        ...
        <div class="pagetitle mt-5">
            <h1>Tambah Fasilitas pendidikan</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Tambah Fasilitas pendidikan</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses_universitas.php">
                        <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-2 col-form-label">NPSN</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                   <button type="submit" class="btn btn-primary"> <i class="bi-check"></i> Kirim</button>
                                    <button class="btn btn-danger"> <a href="../fasilitas_desa.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                                </div>
                            </div>
