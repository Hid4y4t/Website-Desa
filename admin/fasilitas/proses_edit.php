...
$sql = "update rencana_pembangunan set jenis_pembangunan='$jenis_pembangunan', nama_pembangunan='$nama_pembangunan', anggaran='$anggaran', rencana_mulai_pembangunan='$rencana_mulai_pembangunan', rencana_akhir_pembangunan='$rencana_akhir_pembangunan', lokasi_pembangunan='$lokasi_pembangunan' where id_pembangunan='$id_pembangunan'";
...
if ($hasil) {
    echo "<script>alert('BERSAHIL DI INPUTKAN '); window.location.href='rencana_pembangunan.php'</script>";
} else {
