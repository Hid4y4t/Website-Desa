        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Rencana Pembangunan</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                        <h3> Rencana Pembangunan<br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                       <a href="proses_umum/tambah_rencana.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Rencana Pembangunan</i></button></a>
                                    </div>
                                </h5>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="view_rencana.php?id_pembangunan=<?php echo $d['id_pembangunan']; ?>"><button type="button" class="btn btn-outline-primary">Detail</button></a>
                                                        <a href="edit_rencana.php?id_pembangunan=<?php echo $d['id_pembangunan']; ?>"><button type="button" class="btn btn-outline-warning">Edit</button></a>
                                                        <a href="#" onClick="confirm_modal('proses_umum/hapus_rencana.php?id_pembangunan=<?php echo $d['id_pembangunan']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
