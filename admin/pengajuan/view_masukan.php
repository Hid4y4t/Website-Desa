        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-5">
                    ...
                    $id = $_GET['id'];
                    $data = mysqli_query($koneksi, "select * from masukan where id='$id'");
                    while ($d = mysqli_fetch_array($data)) {
                    ?>
                        <table class="table caption-top">
                            <button class="btn btn-primary"> <a href="masukan.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                        ...
                        <embed type="application/pdf" src="aduan/<?php echo $d['foto']; ?>" width="100%" height="500"><br><br>
                    <?php
                    }
                    ?>
                </div>
