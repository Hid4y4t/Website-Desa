                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                        <h3> SURAT PENGAJUAN WARGA<br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover" id="table_7">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from surat_pengajuan ");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="view_surat.php?id_surat=<?php echo $d['id_surat']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="#" onClick="confirm_modal('hapus_surat.php?id_surat=<?php echo $d['id_surat']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
