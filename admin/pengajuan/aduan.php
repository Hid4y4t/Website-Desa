                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>ADUAN WARGA<br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="view_aduan.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="#" onClick="confirm_modal('hapus_aduan.php?id=<?php echo $d['id']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
