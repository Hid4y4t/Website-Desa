                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                        <h3> PROPOSAL PENGAJUAN WARGA<br> DESA Ngadiroyo</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover" id="table_7">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from proposal_pengajuan");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo $d['jenis_proposal']; ?></td>
                                                    <td><?php echo $d['nama_lengkap']; ?></td>



                                                    <td>
                                                        <a href="view_proposal.php?id_proposal=<?php echo $d['id_proposal']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="#" onClick="confirm_modal('hapus_surat.php?id_proposal=<?php echo $d['id_proposal']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
