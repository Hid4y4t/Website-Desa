        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-5">
                    ...
                    $data = mysqli_query($koneksi, "select * from surat_pengajuan where id_surat='$id_surat'");
                    while ($d = mysqli_fetch_array($data)) {
                    ?>
                        <table class="table caption-top">
                            <button class="btn btn-primary"> <a href="pengajuan_surat.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                            <caption>Surat Pengajuan</caption>
                        ...
                        <embed type="application/pdf" src="pengajuan/<?php echo $d['surat']; ?>" width="100%" height="500"><br><br>
                    <?php
                    }
                    ?>
                </div>
