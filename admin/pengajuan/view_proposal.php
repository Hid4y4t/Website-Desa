        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-5">
                    ...
                    $data = mysqli_query($koneksi, "select * from proposal_pengajuan where id_proposal='$id_proposal'");
                    while ($d = mysqli_fetch_array($data)) {
                    ?>
                        <table class="table caption-top">
                            <button class="btn btn-primary"> <a href="pengajuan_proposal.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                            <caption>Proposal Pengajuan</caption>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>NOMOR HP/EMAIL PENANGGUNG JAWAB</td>
                                    <td>: <?php echo $d['nomo_hp']; ?></td>
                                </tr>
                                <tr>
                        ...
                        <embed type="application/pdf" src="pengajuan/<?php echo $d['proposal']; ?>" width="100%" height="500"><br><br>
                    <?php
                    }
                    ?>
                </div>
