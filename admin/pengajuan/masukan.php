                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>MASUKAN WARGA<br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover" id="table_1">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from masukan ");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="view_masukan.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="#" onClick="confirm_modal('hapus_masukan.php?id=<?php echo $d['id']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
