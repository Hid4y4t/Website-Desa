                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                      <h3>  Galeri<br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                       <a href="tambah_galeri.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Galeri</i></button></a>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="view_galeri.php?id_galeri=<?php echo $d['id_galeri']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                       
                                                        <a href="#" onClick="confirm_modal('hapus_galeri.php?id_galeri=<?php echo $d['id_galeri']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
