        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="artikel_desa.php">
                            <i class="bi bi-circle"></i><span>Artikel Desa</span>
                        </a>
                    </li>
                    <li>
                        <a href="galeri_desa.php">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Artikel Desa</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="card-body">
                                    ...
                                    $data_warga_miskin = mysqli_query($koneksi, "SELECT * FROM artikel_desa");
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6><?php echo $jumlah_warga_miskin; ?> Artikel</h6>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                      <h3>  Artikel<br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                      <a href="tambah_artikel.php">  <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Artikel</i></button></a>
                                    </div>
                                </h5>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" onClick="confirm_modal('hapus_artikel.php?id_artikel=<?php echo $d['id_artikel']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
