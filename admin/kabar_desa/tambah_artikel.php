            ...
            <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="proses_tambah_artikel.php" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="inputPassword" class="col-sm-2 col-form-label">ISI ARTIKEL</label>
                            <div class="col-sm-10">
                                <textarea class="tinymce-editor" name="keterangan" id="misi"></textarea>
                            </div>
                            <input type="hidden" class="form-control" placeholder="Masukkan Nama artikel" name="waktu">
