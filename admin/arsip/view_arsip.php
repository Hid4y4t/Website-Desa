        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-5">
                    ...
                    $id = $_GET['id'];
                    $data = mysqli_query($koneksi, "select * from arsip_lain where id='$id'");
                    while ($d = mysqli_fetch_array($data)) {
                    ?>
                        <table class="table caption-top">
                            <button class="btn btn-primary"> <a href="arsip_lain.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo "<a href='download_arsip.php?file=$d[berkas]'><button> Download</button></a>"; ?></td>
                                </tr>
                            </tbody>

                        </table>
                        <embed type="application/pdf" src="arsip_lain/<?php echo $d['berkas']; ?>" width="100%" height="500"><br><br>
