...
<body>
    ...
    <div class="container">
        ...
        <div class="pagetitle mt-5">
            <h1>Tambah Arsip Proposal Masuk</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active">Tambah Arsip Proposal Masuk</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses/proses_proposal_masuk.php"  enctype="multipart/form-data">
                            <div class="row mb-3">
