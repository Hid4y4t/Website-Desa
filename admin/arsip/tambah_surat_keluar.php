...
<body>
    ...
    <div class="container">
        ...
        <div class="pagetitle mt-5">
            <h1>Tambah Arsip Surat Keluar</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active">Tambah Arsip Surat Keluar</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses/proses_surat_keluar.php"  enctype="multipart/form-data">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="tetx" class="form-control" name="nomor">
                                </div>
                            </div>
                            <div class="row mb-3">
