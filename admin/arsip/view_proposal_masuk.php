        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-5">
                    ...
                    $data = mysqli_query($koneksi, "select * from arsip_proposal_masuk where id_arsip_proposal_masuk='$id_arsip_proposal_masuk'");
                    while ($d = mysqli_fetch_array($data)) {
                    ?>
                        <table class="table caption-top">
                        <button class="btn btn-primary"> <a href="arsip_proposal.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo "<a href='download_proposal.php?file=$d[foto]'><button> Download</button></a>";?></td>
                                </tr>
                            </tbody>
                          
                        </table>
                        <embed type="application/pdf" src="arsip_proposal/<?php echo $d['foto']; ?>" width="100%" height="500"><br><br>
