        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Arsip Berkas</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                        <h3> Arsip Berkas <br> DESA NGADIROYO</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                        <a href="tambah_arsip.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Arsip </i></button></a>
                                    </div>
                                </h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_id">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from arsip_lain");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_arsip.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="#" onClick="confirm_modal('proses/hapus_arsip.php?id=<?php echo $d['id']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
