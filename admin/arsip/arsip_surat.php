                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            ...
                                            $data_masuk = mysqli_query($koneksi, "SELECT * FROM arsip_surat_masuk");
                                            // menghitung data barang
                                            $jumlah_masuk = mysqli_num_rows($data_masuk);
                                            ?>
                                            <div class="ps-3">
                                                <h6><?php echo $jumlah_masuk; ?> Surat</h6>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                        <h3> Arsip Surat<br> DESA Ngadiroyo</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                        <a href="tambah_surat_masuk.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Arsip Surat Masuk</i></button></a>
                                    </div>
                                </h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_id">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from arsip_surat_masuk");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo $d['prihal']; ?></td>
                                                    <td><?php echo $d['pengirim']; ?></td>
                                                    <td><?php echo $d['tanggal']; ?></td>
                                                    <td>
                                                        <a href="view_surat_masuk.php?id_arsip_surat_masuk=<?php echo $d['id_arsip_surat_masuk']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="#" onClick="confirm_modal('proses/hapus_surat_masuk.php?id_arsip_surat_masuk=<?php echo $d['id_arsip_surat_masuk']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <div class="icon">
                                        <a href="tambah_surat_keluar.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Arsip Surat Keluar</i></button></a>
                                    </div>
                                </h5>
                                <!-- Table with hoverable rows -->
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_2">
                                        ...
                                        <tbody>
                                            ...
                                            include '../../koneksi/koneksi.php';
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from arsip_surat_keluar");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    ...
                                                    <td><?php echo $d['tanggal']; ?></td>
                                                    <td>
                                                        <a href="view_surat_keluar.php?id_arsip_surat_keluar=<?php echo $d['id_arsip_surat_keluar']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                        <a href="#" onClick="confirm_modal('proses/hapus_surat_keluar.php?id_arsip_surat_keluar=<?php echo $d['id_arsip_surat_keluar']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
