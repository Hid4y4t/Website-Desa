                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses/proses_arsip.php" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-2 col-form-label">Berkas</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <button class="btn btn-danger"> <a href="arsip_lain.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                                </div>
                            </div>
