        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-5">
                    ...
                    $data = mysqli_query($koneksi, "select * from arsip_foto where id_arsip_foto='$id_arsip_foto'");
                    while ($d = mysqli_fetch_array($data)) {
                    ?>
                        <table class="table caption-top">
                            <button class="btn btn-primary"> <a href="arsip_kegiatan.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div class="card info-card revenue-card">
                                    <div class="card-body">
                                        <img src="foto/<?php echo $d['foto1']; ?>" alt="" style="width: 100%; ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div class="card info-card revenue-card">
                                    <div class="card-body">
                                        <img src="foto/<?php echo $d['foto2']; ?>" alt=""style="width: 100%; ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div class="card info-card revenue-card">
                                    <div class="card-body">
                                        <img src="foto/<?php echo $d['foto3']; ?>" alt=""style="width: 100%; ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div class="card info-card revenue-card">
                                    <div class="card-body">
                                        <img src="foto/<?php echo $d['foto4']; ?>" alt=""style="width: 100%; ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div class="card info-card revenue-card">
                                    <div class="card-body">
                                        <img src="foto/<?php echo $d['foto5']; ?>" alt=""style="width: 100%;  ">
                                    </div>
                                </div>
                            </div>
