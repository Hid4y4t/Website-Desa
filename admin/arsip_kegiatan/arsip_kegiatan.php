        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Arsip Kegiatan</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-title">
                                    <center>
                                        <h3> Arsip Kegiatan<br> DESA Ngadiroyo</h3>
                                    </center>
                                </h5>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <center>
                                        <h3><b> Arsip Foto</b></h3>
                                    </center>
                                    <div class="icon">
                                       <a href="tambah_foto.php"> <button type="button" class="btn btn-outline-primary"> <i class="ri-add-circle-fill">Tambah Arsip Foto</i></button></a>
                                    </div>
                                </h5>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        ...
                                        <?php
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "select * from arsip_foto");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="view_foto.php?id_arsip_foto=<?php echo $d['id_arsip_foto']; ?>"><button type="button" class="btn btn-outline-primary">Lihat</button></a>
                                                       
                                                        <a href="#" onClick="confirm_modal('hapus_foto.php?id_arsip_foto=<?php echo $d['id_arsip_foto']; ?>');"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                                                    </td>
