...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($judul_galeri_err)  && empty($foto01_err) ) {
        ...
        $sql = "INSERT INTO arsip_foto (judul_galeri, foto1, foto2, foto3, foto4, foto5) VALUES ( ?, ?,?,?,?, ?)";
        if ($stmt = mysqli_prepare($koneksi, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                // Redirect 
                echo "Berhasil nyimpan data <img src='foto/$param_foto1' height='60'>";
                echo "<meta http-equiv=\"refresh\"content=\"2;URL=tambah_foto.php\"/>";
            } else {
                        ...
                        <form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <button class="btn btn-danger"> <a href="arsip_kegiatan.php" style="color:white ; "> <i class="bi-backspace-fill"></i> Kembali</a></button>
                                </div>
                            </div>
