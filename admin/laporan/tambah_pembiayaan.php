        ...
        <div class="pagetitle mt-5">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tambah Pembiayaan</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="proses_tambah_biaya.php">
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Jenis Biaya</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pembiayaan">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="tetx" class="form-control" name="anggaran">
                                </div>
                            </div>
